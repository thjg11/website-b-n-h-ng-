...
Class Master extends DBConnection {
	...
	function save_category(){
		...
		if($save){
			$resp['status'] = 'success';
			if(empty($id))
				$this->settings->set_flashdata('success',"Đã tạo sản phẩm mới");
			else
	...
	function save_sub_category(){
		...
		if($save){
			$resp['status'] = 'success';
			if(empty($id))
				$this->settings->set_flashdata('success',"Đã tạo hạng mục mới");
			else
				$this->settings->set_flashdata('success',"Đã lưu");
		}else{
			$resp['status'] = 'failed';
	...
	function save_inventory(){
		...
		if($save){
			$resp['status'] = 'success';
			if(empty($id))
				$this->settings->set_flashdata('success',"Đã tạo");
			else
				$this->settings->set_flashdata('success',"Đã lưu");
		}else{
			$resp['status'] = 'failed';
	...
	function update_order_status(){
		...
		if($update){
			$resp['status'] ='success';
			$this->settings->set_flashdata("success"," Đã cập nhật trạng thái.");
		}else{
			$resp['status'] ='failed';
