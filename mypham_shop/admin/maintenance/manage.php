...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Tạo " ?>Create Package</h3>
	</div>
	<div class="card-body">
	...
	<div class="card-footer">
		...
		<a class="btn btn-flat btn-default" href="?page=responses">Thoát</a>
	</div>
</div>
<script>
        ...
        $.ajax({
            ...
            success:function(resp){
                ...
                if(typeof resp =='object' && resp.status == 'success'){
                    ...
                    alert_toast("Ảnh đã xóa ","Thông báo");
                }else{
                    console.log(resp)
                    alert_toast("Đã xảy ra lỗi khi xóa hình ảnh","Lỗi");
                }
