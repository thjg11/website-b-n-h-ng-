...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Tạo" ?> Hạng mục sản phẩm</h3>
	</div>
	<div class="card-body">
		<form action="" id="category-form">
			<input type="hidden" name ="id" value="<?php echo isset($id) ? $id : '' ?>">
            <div class="form-group">
				<label for="parent_id" class="control-label">Thuộc nhóm</label>
			...
			<div class="form-group">
				<label for="sub_category" class="control-label">Tên hạng mục</label>
	...
	<div class="card-footer">
		...
		<a class="btn btn-flat btn-default" href="?page=maintenance/sub_category">Thoát</a>
	</div>
</div>
<script>
