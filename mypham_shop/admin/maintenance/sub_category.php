...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">Danh sách hạng sản phẩm</h3>
		<div class="card-tools">
			<a href="?page=maintenance/manage_sub_category" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  Thêm mới</a>
		</div>
	</div>
	<div class="card-body">
							...
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    <a class="dropdown-item" href="?page=maintenance/manage_sub_category&id=<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span> Sửa</a>
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Bạn có chắc chắn xóa hạng mục này vĩnh viễn không?","delete_category",[$(this).attr('data-id')])
		})
		$('.table').dataTable();
	})
