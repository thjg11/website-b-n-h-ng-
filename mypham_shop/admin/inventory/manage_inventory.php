...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Thêm " ?> Sản phẩm tồn kho</h3>
	</div>
	<div class="card-body">
		<form action="" id="inventory-form">
            ...
            <div class="form-group">
				<label for="size" class="control-label">Cỡ</label>
	...
	<div class="card-footer">
		...
		<a class="btn btn-flat btn-default" href="?page=inventory">Thoát</a>
	</div>
</div>
<script>
