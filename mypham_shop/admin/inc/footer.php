...
<footer class="main-footer text-sm">
        ...
        <div class="float-right d-none d-sm-inline-block">
          <b><?php echo $_settings->info('short_name') ?> (by: <a href="#" target="blank">NHÓM 2 - GIAO DIỆN NGƯỜI MÁY</a> )</b>
        </div>
      </footer>
    </div>
    <script>
    ...
    <div class="daterangepicker ltr show-ranges opensright">
      <div class="ranges">
        <ul>
          ...
          <li data-range-key="Last 7 Days">1 tuần trước</li>
    ...
    <div class="jqvmap-label" style="display: none; left: 1093.83px; top: 394.361px;">thuong</div>