      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Trình đơn thả xuống</a>
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
              <li><a href="#" class="dropdown-item">Các hoạt động </a></li>
              <li><a href="#" class="dropdown-item">Một số hành động khác</a></li>

              <li class="dropdown-divider"></li>

              <li class="dropdown-submenu dropdown-hover">
                <a id="dropdownSubMenu2" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-item dropdown-toggle">Di chuột để hành động</a>
                <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                  <li>
                    <a tabindex="-1" href="#" class="dropdown-item">Bậc 2</a>
                  </li>

                  <li class="dropdown-submenu">
                    <a id="dropdownSubMenu3" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-item dropdown-toggle">Bậc 2</a>
                    <ul aria-labelledby="dropdownSubMenu3" class="dropdown-menu border-0 shadow">
                      <li><a href="#" class="dropdown-item">3 Bậc</a></li>
                      <li><a href="#" class="dropdown-item">3 Bậc</a></li>
                    </ul>
                  </li>

                  <li><a href="#" class="dropdown-item">Bậc 2</a></li>
                  <li><a href="#" class="dropdown-item">Bậc 2</a></li>
                </ul>
              </li>
            </ul>
            ...
            <a href="#" class="dropdown-item">
              <div class="media">
                ...
                <div class="media-body">
                  ...
                  <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i> 4 giwof trước</p>
                </div>
              </div>
            </a>
            <div class="dropdown-divider"></div>
