    ...
    <div class="container px-4 px-lg-5 my-5">
        <div class="row gx-4 gx-lg-5 align-items-center">
            ...
            <div class="col-md-6">
                ...
                <div class="fs-5 mb-5">
                <span id="price"><?php echo $inv[0]['price'] ?> VNĐ</span>
                <br>
                <span><small><b>Số lượng hiện có</b> <span id="avail"><?php echo $inv[0]['quantity'] ?></span></small></span>
                </div>
...
<section class="py-5 bg-light">
    <div class="container px-4 px-lg-5 mt-5">
        <h2 class="fw-bolder mb-4">Những sảm phẩm tương tự</h2>
        ...
        <?php 
            ...
            while($row = $products->fetch_assoc()):
                ...
                $_inv = array();
                while($ir = $inventory->fetch_assoc()){
                    $_inv[$ir['id']] = number_format($ir['price']);
                }
        ?>
            <div class="col mb-5">
