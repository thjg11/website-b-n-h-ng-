            ...
            <form action="" id="place_order">
                ...
                <div class="row row-col-1 justify-content-center">
                    <div class="col-6">
                        ...
                        <div class="col">
                            <span><h4><b>Tổng:</b> <?php echo number_format($total) ?> VNĐ</h4></span>
                        </div>
                        <hr>
                        <div class="col my-3">
                        <h4 class="text-muted">Phương thức thanh toán</h4>
                            <div class="d-flex w-100 justify-content-between">
                                <button class="btn btn-flat btn-dark">Thanh toán khi giao hàng</button>
        ...
        $.ajax({
            ...
            success:function(resp){
                if(!!resp.status && resp.status == 'success'){
                    alert_toast("Đã đặt hàng thành công.","Thông báo")
                    setTimeout(function(){
                        location.replace('./')
                    },2000)
                }else{
