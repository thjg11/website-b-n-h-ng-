...
<footer class="py-5 bg-dark">
            <div class="container">
              <p class="m-0 text-center text-white">Bản quyền &copy; <?php echo $_settings->info('short_name') ?> 2021</p>
              <p class="m-0 text-center text-white">Được phát triển bởi:<a href="#">Nhóm 2-GIAO DIỆN NGƯỜI MÁY</a></p>
          </div>
        </footer>
