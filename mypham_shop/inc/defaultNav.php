            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
              ...
              <li class="dropdown-submenu dropdown-hover">
                ...
                <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                  <li>
                    <a tabindex="-1" href="#" class="dropdown-item">Cấp độ 2</a>
                  </li>

                  <li class="dropdown-submenu">
                    <a id="dropdownSubMenu3" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-item dropdown-toggle">Cấp độ 2</a>
                    <ul aria-labelledby="dropdownSubMenu3" class="dropdown-menu border-0 shadow">
                      <li><a href="#" class="dropdown-item">3 Cấp độ</a></li>
                      <li><a href="#" class="dropdown-item">3 Cấp độ</a></li>
                    </ul>
                  </li>

                  <li><a href="#" class="dropdown-item">Cấp độ 2</a></li>
                  <li><a href="#" class="dropdown-item">Cấp độ 2</a></li>
                </ul>
              </li>
            </ul>
